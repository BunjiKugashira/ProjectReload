	...
	private static final class LockManager {
		...
		private static class FieldInfo {
			...
			public String toString() {
				String s = "StartClassFieldInfo: " + super.toString() + "\n";
				s += "Field: " + _field.toString() + "\n";
				s += "Reserved: \n";
		...
		private static class ThreadInfo {
			...
			public String toString() {
				String s = "StartClassThreadInfo: " + _thr.toString() + "\n";
				s += "Name = " + _thr.getName() + "\n";
				s += "FieldInfos: \n";
			...
			public final void register(Instant pInst, Field[] pF, FieldInfo... fi) throws DeadlockException, TimeoutException {
				...
				criticalStuff(new Runnable() {
					...
					public void run() {
						...
						if (sleep._content) {
							ManagedThread.currentThread().setTired(ThreadSafeMethod.class);
						}
					}
				...
				if (sleep._content) {
					...
					if (ManagedThread.sleep(ThreadSafeMethod.class, sleepTime)) {
				...
				criticalStuff(new Runnable() {
					...
					public void run() {
						...
						if (!_acknowledged.contains(false)) {
							...
							_waiting = null;
							_waitingFields = null;
							_thr.wakeUp(ThreadSafeMethod.class);
						}
					}
