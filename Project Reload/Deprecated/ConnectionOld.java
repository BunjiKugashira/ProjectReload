...
public class ConnectionOld {
	...
	private ConnectionOld _partner;
	...
	public ConnectionOld(final ConnectionOld pPartner) {
		_sock = null;
		_partner = pPartner;
	...
	public ConnectionOld(final InetSocketAddress pAddress) throws IOException {
		_sock = new Socket();
		_partner = null;
		try {
	 ...
	 *            TODO comment
	 */
	public ConnectionOld(final Socket pSock) {
		_sock = pSock;
		_partner = null;
	}
